...
function sendmail($name,$password,$mailid) {
									...
									<div class='contentEditableContainer contentTextEditable'>
					                	<div class='contentEditable' align='left' >
					                  		<p >Hi $name,
					                  			<br/>
					                  			<br/>
												Welcome to the Appraisal application. This is an application that helps you to get in touch with faculty. The application provides instant feedback to the faculty about the effectiveness of the topic delevired. The goal is to get to know the level of your understanding.<br/><br/>Your Login creditinals are '$password'.<br/><br/>In case of any issue get back to us at nandan.beis.12@acharya.ac.in or contact admin.<br/><br/>Thanks<br/><img src='http://i.imgur.com/WySAVOI.png' width='100' height='25'  alt='Logo'  data-default='placeholder' /></p>
					                	</div>
					              	</div>
								</td>
								<td width='100'>&nbsp;</td>
